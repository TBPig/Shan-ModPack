ServerEvents.recipes((event) => {
  ...
  redStonePrototype('create:pulse_repeater', 1)
  redStonePrototype('create:pulse_extender', 1)
  redStonePrototype('create:pulse_timer', 1)
  redStonePrototype('create:powered_latch', 1)
  redStonePrototype('create:powered_toggle_latch', 1)
  redStonePrototype('create:content_observer', 1)
  redStonePrototype('create:stockpile_switch', 1)
